...
<div class="row mb-3">
	...
	<div class="col-sm-10">
		<input type = "text" class="form-control" name="remember_token" value="{{$customer->remember_token}}" id="remember_token" placeholder="Remember Token">
	</div>
</div>
<div class="row mb-3">
...
<div class="row mb-3">
	...
	<div class="col-sm-10">
		<input type = "text" class="form-control" name="photo2" value="{{$customer->photo2}}" id="photo2" placeholder="Photo2">
	</div>
</div>
