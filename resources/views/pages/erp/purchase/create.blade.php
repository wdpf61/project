                ...
                <div class="invoice-wrap">
                    <div class="row">
                                    ...
                                    <table class="table datatable">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><input type="text"  class=" form-control p_price"></th>
                        ...
                        <div class="col-md-6 ">
                            ...
                            <button class="btn btn-primary btn_process">Purchase</button>
                        </div>
...
@section('script')
    <script>
        $(function() {
            const purchase = new Cart('purchase');
            printCart();
            ...
            function cartIconIncrease() {
                let items = purchase.getCart()?.length ?? 0
                $(".cartIcon").html(items);
            }
