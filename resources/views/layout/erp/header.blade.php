                ...
                <ul class="d-flex align-items-center">
                    ...
                    <li class="header-cart">
                        <a href="#" class="d-block head-icon position-relative" role="button"
                            ...
                            <span
                                class="position-absolute translate-middle badge rounded-pill bg-danger badge-notification cartIcon">0</span>
                        </a>
                            ...
                            <div class="offcanvas-footer">
                                <div class="head-box-footer p-3">
                                    ...
                                    <div class="header-cart-btn">
                                        <a href="./cart.html" target="_blank" role="button"
                                            class="btn btn-light-primary">
                                            <i class="ti ti-eye"></i> View Cart</a>
                                        <a href="./checkout.html" target="_blank" role="button"
                                        ...
                                        <div class="notification-message head-box">
                                            ...
                                            <div class="message-content-box flex-grow-1 ps-2">
                                                ...
                                                <a href="./read_email.html" class="f-s-15 text-secondary mb-0"><span
                                                        class="f-w-500 text-secondary">{{ $notification->data['message'] }}</span>
                                                    wants to edit <span
                                                        class="f-w-500 text-secondary">Report.doc</span></a>
                                                <div>
                                                    <a class="d-inline-block f-w-500 text-success me-1"
                                                        href="{{ url("/notifications/$notification->id/read") }}">Approve</a>
                                            ...
                                            <div class="align-self-start text-end">
                                              <a  href="{{ url("/notifications/$notification->id/delete") }}"> <i class="ph ph-trash f-s-18 text-danger close-btn"></i></a>
                                    ...
                                    @endforelse ( )
                                      ...
                                      <div class="">
                                        <div style="display: flex; text-align:center; justify-content:center;">
                                            <a  class="d-inline-block f-w-500 text-danger "
                                                href="{{ url("/notifications/delete") }}">Clear All</a>
                                        </div>
                                     </div>
                                      @endif
                                ...
                                <ul class="">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center justify-content-between">
                                            <a class="f-w-500" role="button" href="./setting.html" target="_blank"
                                            ...
                                            <div class="card-body">
                                                <div class="text-center">
                                                    ...
                                                    <div class="flex-shrink-0 mt-3">
                                                        <a href="pricing.html" target="_blank" role="button"
                                                            class="btn btn-dark text-white d-block m-auto w-125">Upgrade</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
