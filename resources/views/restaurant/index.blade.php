        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
          <ul class="carousel-indicators">
            <li data-target="#carouselExampleIndicators" data-slide-to="0">
              <figure><img src="{{ asset('asset_restaurant') }}/images//banner-smol-img2.png" alt="image"></figure>
            </li>
            <li data-target="#carouselExampleIndicators" class="active" data-slide-to="1">
              <figure><img src="{{ asset('asset_restaurant') }}/images//banner-smol-img1.png" alt="image"></figure>
            </li>
            <li data-target="#carouselExampleIndicators" data-slide-to="2">
              <figure><img src="{{ asset('asset_restaurant') }}/images//banner-smol-img3.png" alt="image"></figure>
            </li>
          </ul>
          <div class="carousel-inner">
            <div class="carousel-item">
              <figure><img src="{{ asset('asset_restaurant') }}/images//banner-img2.png" alt="image" class="img-fluid"></figure>
            </div>
            <div class="carousel-item active">
              <figure><img src="{{ asset('asset_restaurant') }}/images//banner-img1.png" alt="image" class="img-fluid"></figure>
            </div>
            <div class="carousel-item">
              <figure><img src="{{ asset('asset_restaurant') }}/images//banner-img3.png" alt="image" class="img-fluid"></figure>
            </div>
          </div>
